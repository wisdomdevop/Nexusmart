            ...
            <div className='w-[90%] md:w-[40%] '>
                ...
                <form action="">
                    <div className='w-[100%] border rounded-full p-2 flex  gap-10 px-4'>
                        <input type="email" placeholder='S@Nexusmart.com' className='outline-none md:w-[80%] w-[60%] text-sm md:text-base' />
                        <button className='bg-coral-red text-white w-[50%] rounded-3xl py-3 '>
                            Sign Up
                        </button>
                    </div>
                </form>
