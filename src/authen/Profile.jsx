        ...
        {userDetails?
         (
            <div className='shadow-3xl md:h-[550px] flex flex-col items-center justify-center w-[80%] lg:w-[40%] lg:gap-10 gap-5 rounded-lg animate-slideDown   p-20 h-[100%]'>
                <div>
                    <img src={userDetails.imgURL} alt="" className='rounded-full object-cover pt-8'/>
                </div>
                ...
                <button className='p-4 bg-purple-600 font-bold rounded-xl text-white w-[40%]' onClick={handleLogout}>
                    Logout
                </button>
            </div>
         ): 
