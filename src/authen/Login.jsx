...
const Login = () => {
  ...
  return (
    <div className='flex justify-center items-center mt-12'>
      <section className='bg-orange-200 h-[500px] w-[40%] rounded-l-2xl hidden md:flex animate-slideIn items-center justify-center'>
        <div>
          <h1 className='text-black font-bold text-lg md:text-2xl'>
            WELCOME BACK
          </h1>

          <img src="/loginsider.jpg" alt="" />
      ...
      <section className='flex flex-col justify-center shadow-3xl h-[500px] md:w-[40%] w-[80%] rounded-r-xl animate-slideDown'>
        ...
        <div className='flex items-center gap-3 border p-2 rounded-xl w-[80%] font-medium'>
          ...
          <div>
            <h1 className='text-sm md:text-base'>Dont Have an account? <Link to='/register' className='text-orange-500'>Register</Link></h1>
          </div>
        </form>
      </section>
    </div>
