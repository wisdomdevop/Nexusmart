...
const p2p = "https://www.logomaker.com/api/main/images/1j+ojlxEOMkX9Wyqfhe43D6kh...GIqhJPmRrJwXs1M3EMoAJtlyIthvNr...PgyPExevg9C3ktKMcs8"
...
const Register = () => {
   ...
   const [imgUrl, setImgUrl]= useState("https://www.logomaker.com/api/main/images/1j+ojlxEOMkX9Wyqfhe43D6kh...GIqhJPmRrJwXs1M3EMoAJtlyIthvNr...PgyPExevg9C3ktKMcs8");
    ...
    <div className='h-[100%] flex  justify-center items-center md:py-12 p-4'>
        <section className='bg-black w-[40%] h-[600px] items-center justify-center my-auto rounded-l-xl shadow-xl hidden md:flex animate-slideIn'>
          <div className='text-center justify-center items-center  '>
            <img src="/altlogo.jpg" alt="" className='mx-auto flex p-48 ' />
          </div>
        </section>
        ...
        <section className='flex flex-col gap-6 lg:p-4 items-center border-2 md:h-[600px] h-[100%] p-12 justify-center md:rounded-r-xl rounded-xl shadow-3xl md:w-[50%] mini:[w-80%] padAir:[w-80%] w-[100%] animate-slideDown' >
          <form onSubmit={handleRegister} className='flex flex-col items-center gap-10 w-[90%] justify-center mini:w-[100%] '>
            <div className='mb-4'>
            ...
            <div className='flex flex-col padAir:flex-row gap-8 w-[100%] items-center justify-center mini:w-[full]'>
              ...
              <div className='flex gap-2 items-center border-2 border-zinc-300 rounded-xl p-3'>
            ...
            <div className='flex flex-col padAir:flex-row gap-8 w-[100%]  items-center justify-center'>
             ...
             <div className='w-[100%] spro:w-[80%] mt-12'>
              <button className='bg-orange-300 w-[100%] p-3 rounded-xl font-semibold font-montserrat' type='submit'>
                Register
              </button>
            </div>

            <div className='text-sm md:text-base text-right '>
              <h2>Already Have an Account? <Link to='/login' className='text-orange-600  '> Login</Link></h2>
            </div>
